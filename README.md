...
Open-source **[Flask Dashboard](https://appseed.us/admin-dashboards/flask)** generated by `AppSeed` op top of a modern design. **[SRTdash Admin](https://appseed.us/admin-dashboards/flask-dashboard-srtdash)** is a free Bootstrap 4 HTML5 admin dashboard template. It is a perfect match for the website admin and web-apps. Srtdash has a modern design with a beautiful, clean and minimal look. There is two different type of navigation bar styles and three unique home versions.
